/**
 * Generated by tsnapi — public API snapshot of `@xwbx/eslint-config` */
// Interfaces
...
export declare function e18e(_?: OptionsE18e & OptionsProjectType & OptionsIsInEditor): Promise<TypedFlatConfigItem[]>;
export declare function ensurePackages(_: (string | undefined)[]): Promise<void>;
export declare function formatters(_?: OptionsFormatters): Promise<TypedFlatConfigItem[]>;
...
export declare function imports(_?: OptionsOverrides): Promise<TypedFlatConfigItem[]>;
...
export declare function jsdoc(): Promise<TypedFlatConfigItem[]>;
export declare function jsonc(_?: OptionsFiles & OptionsOverrides): Promise<TypedFlatConfigItem[]>;
...
export declare function toml(_?: OptionsOverrides & OptionsFiles): Promise<TypedFlatConfigItem[]>;
...
export declare function xwbx(_?: OptionsConfig & Omit<TypedFlatConfigItem, "files" | "ignores">, ..._: Awaitable<TypedFlatConfigItem | TypedFlatConfigItem[] | FlatConfigComposer<any, any> | Linter.Config[]>[]): FlatConfigComposer<TypedFlatConfigItem, ConfigNames>;
export declare function yaml(_?: OptionsOverrides & OptionsFiles): Promise<TypedFlatConfigItem[]>;
